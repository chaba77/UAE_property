##[pylyzer] failed /home/ether/Desktop/testingThings/realstate/activate/lib/python3.11/site-packages/werkzeug/routing/rules.py 1753141474 32510
...
.Rule.suitable_for: |E: Type, R: Type, Type_36821 <: Structural({.__contains__ = (self: Never, ?R) -> Bool; .__getitem__ = (self: Obj, ?E) -> ?E})|(self: rules.Rule, values: Type_36821, method: NoneType or Str := {None} and NoneType or Str) -> Bool
