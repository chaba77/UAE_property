##[pylyzer] failed /home/ether/Desktop/testingThings/realstate/activate/lib/python3.11/site-packages/bs4/builder/__init__.py 1753451621 31130
...
.__all__: global::List!({"SAXTreeBuilder", "TreeBuilderRegistry", "TreeBuilder", "HTMLTreeBuilder"}, 4)
.FAST: {"fast"}
...
.HTML: {"html"}
.HTML_5: {"html5"}
.__all__: global::List!({"HTMLTreeBuilder", "TreeBuilderRegistry", "TreeBuilder", "ParserRejectedMarkup", "DetectsXMLParsedAsHTML"}, 5)
...
.TreeBuilderRegistry.register: |T <: Structural({.features = ?9683}), Type_9683 <: global::Iterable(?T), T: Type|(self: __init__.TreeBuilderRegistry, treebuilder_class: T) -> NoneType
...
.DetectsXMLParsedAsHTML.warn_if_markup_looks_like_xml: |Type_9958 <: Str, Type_9953: Type, Type_4728 <: Structural({.XML_PREFIX = ?9958; .LOOKS_LIKE_HTML_B = ?9953; .LOOKS_LIKE_HTML = ?9960; ._warn = (self: Obj, stacklevel := ?O) -> ?9971; .XML_PREFIX_B = ?9951}), Type_9951 <: global::Bytes, Type_9960: Type, O: Type, Type_9971: Type|(cls: Type_4728, markup: Obj, stacklevel: Int := {3} and Int) -> Bool
